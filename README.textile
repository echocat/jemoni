...
* @foo.requestsPerSecond@
* @foo.averageRequestDuration@
* @bar.requestsPerSecond@
* @bar.averageRequestDuration@
* @html.requestsPerSecond@
* @html.averageRequestDuration@
* @action.requestsPerSecond@
* @action.averageRequestDuration@
* @requestsPerSecond@ - includes also the values of all other @*.requestsPerSecond@
* @averageRequestDuration@ - includes also the values of all other @*.averageRequestDuration@
